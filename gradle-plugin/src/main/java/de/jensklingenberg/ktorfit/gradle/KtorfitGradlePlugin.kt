...
class KtorfitGradlePlugin : Plugin<Project> {
    ...
    override fun apply(project: Project) {
        ...
        with(project) {
            ...
            val flowConverterDependencyNotation = "de.jensklingenberg.ktorfit:ktorfit-converters-flow:"+ this.getKtorfitConfig().version
            val callConverterDependencyNotation = "de.jensklingenberg.ktorfit:ktorfit-converters-call:"+ this.getKtorfitConfig().version
